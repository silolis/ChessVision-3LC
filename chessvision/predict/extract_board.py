...
from ..utils import BOARD_SIZE, INPUT_SIZE, BoardExtractionError, ratio
...
def extract_board(image, orig, model, threshold=80):
    ...
    if approx is None:
        ...
        # raise BoardExtractionError(r"Failed to find something looking like a chessboard. Make sure the input contains a single chessboard, covering at least 60\% of the image.")
